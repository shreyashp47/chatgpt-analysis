      ...
      >
        <div className="border-t border-[var(--sidebar-border)] p-2">
          <a
            ...
            className="flex items-center gap-2 rounded-xl px-3 py-2 text-xs text-[var(--foreground)]/30 hover:text-[var(--accent)] hover:bg-[var(--message-user)] transition-colors"
          >
